...
class ChatroomConsumer(WebsocketConsumer):
    ...
    def message_handler(self,event):
        ...
        message = grpMsg.objects.get(id=message_id)
        ...
        html = render_to_string("rt_chat/partials/chat_messages_p.html",context=context)
        self.send(text_data=html)

    def update_online_count(self):
        online_count = self.chatroom.users_online.count() - 1
      
        # broadcast the count to all the members of this group
    ...
    def online_count_handler(self,event):
        ...
        print(f"Online count  broadcast: {online_count}") 
